...
public class BatSpawnEgg extends CustomItem {

  private static final String NAME = "Bat Spawn Egg";
  ...
  static {
    loreList.add("Bat Spawn Egg");
    loreList.add("");
  }

  public BatSpawnEgg() {
    super(NAME, loreList, triggerList, CustomItemType.BAT_EGG, 10);
    loreList.add(this.getPrice() + " VoidCoins");
  }

  public ItemStack getInstance() {
    ItemStack is = new ItemStack(Material.BAT_SPAWN_EGG, 1);
