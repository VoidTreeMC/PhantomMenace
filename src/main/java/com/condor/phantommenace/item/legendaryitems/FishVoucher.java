...
public class FishVoucher extends CustomItem {
  ...
  private ItemStack getShulker(Player player) {
    ...
    ItemStack tenVoidCoins = CustomItemManager.getItemByType(CustomItemType.DEFENDER_TOKEN).getInstance();
    tenVoidCoins.setAmount(10);
    ...
    ItemStack sixtyFourSeaGrass = new ItemStack(Material.SEAGRASS, 64);
    ItemMeta seaGrassMeta = sixtyFourSeaGrass.getItemMeta();
    seaGrassMeta.setDisplayName("Sea \"Grass\"");
    sixtyFourSeaGrass.setItemMeta(seaGrassMeta);
    ...
    inventory.setItem(2, sixtyFourTropicalFish);
    inventory.setItem(3, tenVoidCoins);
    inventory.setItem(4, tenVoidCoins);
    inventory.setItem(5, tenVoidCoins);
    inventory.setItem(6, sixtyFourSalmon);
    inventory.setItem(7, thirtyTwoSeaPickles);
    inventory.setItem(8, sixtyFourSalmon);
    inventory.setItem(9, tenVoidCoins);
    inventory.setItem(10, sixtyFourSeaGrass);
    inventory.setItem(11, tenVoidCoins);
    inventory.setItem(12, tenVoidCoins);
    inventory.setItem(13, fishEgg);
    inventory.setItem(14, tenVoidCoins);
    inventory.setItem(15, tenVoidCoins);
    inventory.setItem(16, sixtyFourSeaGrass);
    inventory.setItem(17, tenVoidCoins);
    inventory.setItem(18, sixtyFourPufferfish);
    inventory.setItem(19, thirtyTwoSeaPickles);
    inventory.setItem(20, sixtyFourPufferfish);
    inventory.setItem(21, tenVoidCoins);
    inventory.setItem(22, tenVoidCoins);
    inventory.setItem(23, tenVoidCoins);
    inventory.setItem(24, sixtyFourCod);
