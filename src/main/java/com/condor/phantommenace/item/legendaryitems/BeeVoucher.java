...
public class BeeVoucher extends CustomItem {
  ...
  private ItemStack getShulker(Player player) {
    ...
    ItemStack fifteenVoidCoins = CustomItemManager.getItemByType(CustomItemType.DEFENDER_TOKEN).getInstance();
    fifteenVoidCoins.setAmount(15);
    ...
    inventory.setItem(2, fifteenVoidCoins);
    inventory.setItem(3, sixtyFourRedTulips);
    inventory.setItem(4, fifteenVoidCoins);
    inventory.setItem(5, sixtyFourWhiteTulips);
    inventory.setItem(6, fifteenVoidCoins);
    inventory.setItem(7, sixteenHoneyBottles);
    inventory.setItem(8, twoBeeNests);
    inventory.setItem(9, fifteenVoidCoins);
    inventory.setItem(10, fifteenVoidCoins);
    inventory.setItem(11, sixtyFourHoneycomb);
    inventory.setItem(12, fifteenVoidCoins);
    inventory.setItem(13, beeEgg);
    inventory.setItem(14, fifteenVoidCoins);
    inventory.setItem(15, sixtyFourHoneycomb);
    inventory.setItem(16, fifteenVoidCoins);
    inventory.setItem(17, fifteenVoidCoins);
    inventory.setItem(18, twoBeeNests);
    inventory.setItem(19, sixteenHoneyBottles);
    inventory.setItem(20, fifteenVoidCoins);
    inventory.setItem(21, sixtyFourCornflowers);
    inventory.setItem(22, fifteenVoidCoins);
    inventory.setItem(23, sixtyFourOrangeTulips);
    inventory.setItem(24, fifteenVoidCoins);
