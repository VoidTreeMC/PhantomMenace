...
public class GoldVoucher extends CustomItem {
  ...
  private ItemStack getShulker(Player player) {
    ...
    ItemStack nineteenVoidCoins = CustomItemManager.getItemByType(CustomItemType.DEFENDER_TOKEN).getInstance();
    nineteenVoidCoins.setAmount(19);
    ItemStack sixtyFourGold = new ItemStack(Material.GOLD_INGOT, 64);
    ItemStack sixtyFourGoldBlocks = new ItemStack(Material.GOLD_BLOCK, 64);
    ItemStack sixtyFourRedstoneBlocks = new ItemStack(Material.REDSTONE_BLOCK, 64);
    ItemStack sixtyFourRepeaters = new ItemStack(Material.REPEATER, 64);
    ItemStack sixtyFourComparators = new ItemStack(Material.COMPARATOR, 64);
    ...
    inventory.setItem(0, nineteenVoidCoins);
    inventory.setItem(1, sixtyFourGold);
    inventory.setItem(2, nineteenVoidCoins);
    inventory.setItem(3, sixtyFourGold);
    inventory.setItem(4, sixtyFourRedstoneBlocks);
    inventory.setItem(5, sixtyFourGold);
    inventory.setItem(6, nineteenVoidCoins);
    inventory.setItem(7, sixtyFourGold);
    inventory.setItem(8, nineteenVoidCoins);
    inventory.setItem(9, sixtyFourGoldBlocks);
    inventory.setItem(10, sixtyFourRepeaters);
    inventory.setItem(11, sixtyFourGoldBlocks);
    inventory.setItem(12, nineteenVoidCoins);
    inventory.setItem(13, thankYouBook);
    inventory.setItem(14, nineteenVoidCoins);
    inventory.setItem(15, sixtyFourGoldBlocks);
    inventory.setItem(16, sixtyFourComparators);
    inventory.setItem(17, sixtyFourGoldBlocks);
    inventory.setItem(18, nineteenVoidCoins);
    inventory.setItem(19, sixtyFourGold);
    inventory.setItem(20, nineteenVoidCoins);
    inventory.setItem(21, sixtyFourGold);
    inventory.setItem(22, prideShears);
    inventory.setItem(23, sixtyFourGold);
    inventory.setItem(24, nineteenVoidCoins);
    inventory.setItem(25, sixtyFourGold);
    inventory.setItem(26, nineteenVoidCoins);
